...
\begin{center}
    ...
    \clearpage
    {\bf \Large Mobile Login Page}
    \makebox[\textwidth]{\includegraphics[width=0.5\paperwidth]{storyboard_images/mobile_login.jpeg}}
    
    \clearpage
    {\bf \Large Mobile Card List Page}
    \makebox[\textwidth]{\includegraphics[width=0.5\paperwidth]{storyboard_images/mobile_card_list.jpeg}}
    
    \clearpage
    {\bf \Large Mobile Card View Page}
    \makebox[\textwidth]{\includegraphics[width=0.5\paperwidth]{storyboard_images/mobile_card_page.jpeg}}
    
    \clearpage
    {\bf \Large Mobile Card QR Code View Page}
    \makebox[\textwidth]{\includegraphics[width=0.5\paperwidth]{storyboard_images/mobile_qr_code.jpeg}}
    
    \clearpage
    {\bf \Large Mobile Create/Edit Card Page}
    \makebox[\textwidth]{\includegraphics[width=0.5\paperwidth]{storyboard_images/mobile_create_edit.jpeg}}
